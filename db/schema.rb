...
ActiveRecord::Schema.define(:version => 20130110095412) do
  ...
  add_index "assessment_scores", ["student_id", "batch_id", "descriptive_indicator_id", "exam_id"], :name => "score_index", :limit => {"batch_id"=>nil, "student_id"=>nil, "exam_id"=>nil, "descriptive_indicator_id"=>nil}
  ...
  add_index "batches", ["is_deleted", "is_active", "course_id", "name"], :name => "index_batches_on_is_deleted_and_is_active_and_course_id_and_name", :limit => {"course_id"=>nil, "is_deleted"=>nil, "is_active"=>nil, "name"=>nil}
  ...
  add_index "students", ["nationality_id", "immediate_contact_id", "student_category_id"], :name => "student_data_index", :limit => {"immediate_contact_id"=>nil, "student_category_id"=>nil, "nationality_id"=>nil}
