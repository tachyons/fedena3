...
ActiveRecord::Schema.define(:version => 20130110095412) do
  ...
  add_index "assessment_scores", ["student_id", "batch_id", "descriptive_indicator_id", "exam_id"], :name => "score_index", :limit => {"exam_id"=>nil, "student_id"=>nil, "batch_id"=>nil, "descriptive_indicator_id"=>nil}
  ...
  add_index "batches", ["is_deleted", "is_active", "course_id", "name"], :name => "index_batches_on_is_deleted_and_is_active_and_course_id_and_name", :limit => {"course_id"=>nil, "name"=>nil, "is_deleted"=>nil, "is_active"=>nil}
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"exam_id"=>nil, "student_id"=>nil, "batch_id"=>nil, "observable_id"=>nil, "observable_type"=>nil}
  ...
  add_index "events", ["is_common", "is_holiday", "is_exam"], :name => "index_events_on_is_common_and_is_holiday_and_is_exam", :limit => {"is_holiday"=>nil, "is_exam"=>nil, "is_common"=>nil}
  ...
  add_index "students", ["first_name", "middle_name", "last_name"], :name => "index_students_on_first_name_and_middle_name_and_last_name", :limit => {"first_name"=>"10", "middle_name"=>"10", "last_name"=>"10"}
